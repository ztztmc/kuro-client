...
public class KuroSettingsMenu extends GuiScreen {
    ...
    public KuroSettingsMenu(boolean isInGame, int panoramaTimer) {
        if (panoramaTimer != -1)
    ...
    public void onGuiClosed() {
        ...
        KuroModMenu.panoramaTimer = panoramaTimer;
        super.onGuiClosed();
    ...
    public void initGui() {
        ...
        categoryButtons.add(new KuroCategoryButton(width / 2 - 140, height / 2 - 110, 41, 16, "mods", "Mods", new KuroModMenu(isInGame, panoramaTimer)));
        categoryButtons.add(new KuroCategoryButton(width / 2 - 96, height / 2 - 110, 55, 16, "settings2", "Settings"));

        (searchField = new TextBox(100, "Search settings", this.fontRendererObj, 1, 1, 98, 15)).setFocused(true);
