...
public class TextBox extends Gui
{
    ...
    boolean drawDefaultText = true;

    public TextBox(int componentId, String defaultText, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    {
        if(this.getText() == "")
            drawDefaultText = true;
        else
            drawDefaultText = false;
        ++this.cursorCounter;
    }
    ...
    public void drawTextBox(float newX, float newY)
    {
        this.xPosition = newX;
        this.yPosition = newY;
        if (this.getVisible())
        {
            ...
            {
                RoundedUtils.drawRound(this.xPosition-12, this.yPosition - 0.5f, width, height, 4, new Color(18, 18, 18));
                GlStateManager.enableAlpha();
                GlStateManager.enableBlend();
                GuiImage.drawImage((int) (this.xPosition-10), (int) (yPosition + 1), 12, 12, "kuro/icons/search.png");
            }
            ...
            int l = this.enableBackgroundDrawing ? (int) this.xPosition + 5 : (int) this.xPosition;
            ...
            if(drawDefaultText && s.length() == 0 && !isFocused) {
                FontUtil.normal.drawString(defaultText, (float) l, (float) i1 + 1, new Color(255, 255, 255, 100).getRGB());
            }
            if (s.length() > 0)
            {
                String s1 = flag ? s.substring(0, j) : s;

                j1 = FontUtil.normal.drawString(s1, (float)l, (float)i1+1, i);
            }
            ...
            {
                j1 = FontUtil.normal.drawString(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    FontUtil.normal.drawString("|", (float)k1 + 2, (float)i1 + 1, i);
                }
            }
            ...
            if (k != j)
            {
                ...
                this.drawCursorVertical(k1 + 3, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT);
            }
        }
    }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        {
            p_146188_3_ = (int) (this.xPosition + this.width);
        }

        if (p_146188_1_ > this.xPosition + this.width)
        {
            p_146188_1_ = (int) (this.xPosition + this.width);
        }

        GlStateManager.pushMatrix();
        GlStateManager.enableColorLogic();
        GlStateManager.colorLogicOp(5387);
        RoundedUtils.drawRound(p_146188_3_ + 1, p_146188_4_, p_146188_1_ - p_146188_3_, p_146188_2_ - p_146188_4_, 3, new Color(0,55,190));
