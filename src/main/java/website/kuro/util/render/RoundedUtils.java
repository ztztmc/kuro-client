...
import website.kuro.util.shader.ShaderUtils;

public class RoundedUtils {

    public static ShaderUtils roundedShader = new ShaderUtils("kuro/shaders/roundedRect.frag");
    public static ShaderUtils roundedOutlineShader = new ShaderUtils("kuro/shaders/roundRectOutline.frag");
    private static ShaderUtils roundedTexturedShader = new ShaderUtils("kuro/shaders/roundRectTextured.frag");
    private static ShaderUtils roundedGradientShader = new ShaderUtils("kuro/shaders/roundedRectGradient.frag");
